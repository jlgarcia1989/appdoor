...
const BottomTabNavigatorDriver = () => {
            ...
            <Drawer.Screen name="HomeDrawer" options={{ headerShown: false }}>
                {() => (
                    <View style={{ flex: 1, backgroundColor: "rgba(9, 44, 76, 1)" }}>
                        ...
                        >
                            <Tab.Screen name="Inicio" component={HomeDriver} options={{
                                headerShown: false,
                            ...
                            <Tab.Screen name="Rutas" component={Bookings} options={{
                                headerShown: false,
                                tabBarIcon: ({ color, size }) => (
                                    <Icon name="map-outline" color={color} size={24} />
                                ),
                            }} />
...
export default BottomTabNavigatorDriver;